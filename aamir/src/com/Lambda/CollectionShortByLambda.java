...
public class CollectionShortByLambda {
	public static void main(String[] args) {
		...
		list.addAll(Arrays.asList(new Student123(1, "aamir", "sakinaka"),
		 ...
		 * 
		 * @Override public int compare(Student123 s1, Student123 s2) { return
		 * s1.getName().compareTo(s2.getName()); } }; Collections.sort(list, com);
